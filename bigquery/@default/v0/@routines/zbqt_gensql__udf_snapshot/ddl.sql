create or replace function
    `v0.zbqt_gensql__udf_snapshot`(signature array<string>, repository_table string)
as
    (
        (
            with
    ...
    """, 0),
                    ...
                    ifnull(format(ltrim(`v0.zreindent`("""
      ...
      """, 4)), (select as value * from base_table limit 1)), '')
                )
        )
    )
;
...
begin
  execute immediate `v0.zbqt_gensql__udf_snapshot`(
    [
    `bqmake.v0.zreindent`("""
