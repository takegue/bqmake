CREATE OR REPLACE TABLE FUNCTION `v0.generate_sql__scd_type2`(destination STRUCT<project_id STRING, dataset_id STRING, table_id STRING>, snapshot_query STRING, exp_unique_key STRING)
OPTIONS(
