...
execute immediate `bqtest.zbqt_gensql__table_profiler`("demo_sample_table", null, null);
execute immediate `bqtest.zbqt_gensql__table_profiler`("demo_sample_view", null, null);
