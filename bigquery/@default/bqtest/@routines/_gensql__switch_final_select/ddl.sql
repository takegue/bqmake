create or replace procedure `bqtest._gensql__switch_final_select`(
...
begin
  ...
  call `bqtest._gensql__switch_final_select`(generated_sql, (null, 'zpreview_proto', 'derivative_view'), '__test_count');
